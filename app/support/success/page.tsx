...
import { ArrowRight, FileText, Database, Mail, Heart } from 'lucide-react';

export const metadata = {
  title: 'Thank You for Supporting Q-Psi — Q-Psi Independent Quantum Research',
  ...
  return (
    <div className="min-h-screen bg-surface text-text-primary flex flex-col font-sans">
      ...
      <main className="flex-grow pt-28 pb-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 text-center sm:text-left">
        <div className="bg-surface-card border border-border/80 p-8 sm:p-12 rounded-xl space-y-8 glass-panel glow-box-cyan">
          <div className="flex items-center space-x-2 text-accent font-mono text-xs font-bold uppercase tracking-wider">
            ...
            <span>THANK YOU FOR SUPPORTING Q-PSI</span>
          </div>

          <div className="space-y-4">
            <h1 className="text-4xl sm:text-5xl font-serif font-bold text-text-primary">
              Thank You for Supporting Q-Psi
            </h1>
            <p className="text-base text-text-secondary font-sans leading-relaxed max-w-2xl">
              Thank you for supporting Q-Psi through PayPal. If you completed the PayPal checkout, your contribution is handled by PayPal. Voluntary research support helps fund independent physical-QPU experiments, compute infrastructure, datasets, reproducibility engineering, and open science publication.
            </p>
          </div>

          <div className="p-4 bg-surface border border-border rounded-lg text-xs font-mono text-text-secondary space-y-1">
            <div>Research Support: Voluntary contribution via PayPal hosted checkout</div>
          ...
          <div className="space-y-4 pt-4 border-t border-border/60">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 font-mono text-xs">
              <Link
                href="/research"
                className="p-5 bg-surface border border-border rounded-lg flex flex-col justify-between hover:border-accent transition-all group glass-panel-hover"
              >
