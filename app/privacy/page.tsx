      ...
      <main className="flex-grow pt-28 pb-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="space-y-6 text-sm text-text-secondary leading-relaxed border-t border-border pt-6 font-sans">
          <section className="space-y-2">
            ...
            <p>
              Q-Psi collects information provided voluntarily when you submit a research collaboration inquiry, compiler evaluation request, or contact message. This includes your name, institutional email address, organization, and message contents.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              Submitted contact details are used exclusively to evaluate research collaboration requests, coordinate compiler evaluation access, and deliver requested scientific correspondence. We do not monetize or transfer personal contact information to third parties.
            </p>
          </section>

          <section className="space-y-2">
            <h2 className="text-lg font-serif font-bold text-text-primary">3. Open Science &amp; Telemetry Data</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-serif font-bold text-text-primary">4. Contact &amp; Inquiries</h2>
            <p>
