...
export const siteConfig = {
  ...
  programTotals: {
    totalPhysicalShots: 564840,
    completedAuditedExperimentFamilies: 14,
    productionQpuJobs: 16,
    ibmRuntimeQuantumSeconds: 259.38,
  ...
  claims: [
    ...
    },
    {
      ...
      statement:
        'Multi-backend retargeting and pre-QPU ranking protocol was frozen at commit 7679b9d; physical QPU execution on Fez/Kingston was not completed.',
      shortClaim:
        'Multi-backend retargeting and pre-QPU backend ranking protocol (incomplete).',
      experiment: 'Multi-Backend Selection (QPSI_MULTI_BACKEND_SELECTION_V1)',
      status: 'INCOMPLETE_NOT_FROZEN',
      publicationTier: 'TIER_C',
      qpu: 'Planned: ibm_marrakesh, ibm_fez, ibm_kingston',
      jobId: 'None (Unexecuted)',
      shots: 0,
      quantumSeconds: 0.0,
      sha256: '74864549731b366b31d9ef792633292e51371fdfb3d94438156e9be615c2f09e',
      qualification:
        'Protocol prepared — physical study incomplete. Strictly excluded from completed research totals and completed campaigns.',
      allowedWording: [
        'Multi-backend compiler protocol frozen at commit 7679b9d; physical QPU execution not completed.',
        'Protocol prepared — physical study incomplete.',
      ],
      prohibitedWording: [
        'Multi-backend physical ranking verified.',
        'Multi-backend advantage.',
        'Cross-backend fidelity parity established.',
      ],
  ...
  experiments: [
    ...
    },
    {
      ...
      title: 'MULTI-BACKEND SELECTION PROTOCOL',
      subtitle: 'Cross-Backend Retargeting & Pre-QPU Ranking Protocol',
      category: 'MULTI_BACKEND_RETARGETING_AND_SELECTION',
      backend: 'Planned: ibm_marrakesh, ibm_fez, ibm_kingston',
      processor: 'IBM Heron r2',
      jobIds: [],
      shots: 0,
      quantumSeconds: 0.0,
      qubits: 'Planned 156-Qubit Targets',
      tier: 'TIER_C',
      status: 'INCOMPLETE_NOT_FROZEN',
      statusLabel: 'INCOMPLETE (NOT EXECUTED)',
      primaryResult:
        'Protocol and multi-backend compiled circuits frozen at commit 7679b9d; physical QPU execution not completed.',
      qualification:
        'Protocol prepared — physical study incomplete. Strictly excluded from completed physical campaign totals.',
      rawSha256: '74864549731b366b31d9ef792633292e51371fdfb3d94438156e9be615c2f09e',
      researchNoteUrl: '/methodology',
    },
  ] as ExperimentItem[],
